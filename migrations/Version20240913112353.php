 ...
 */
final class Version20240913112353 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE intro_section (id INT AUTO_INCREMENT NOT NULL, h2_text VARCHAR(500) DEFAULT NULL, sub_h2_text VARCHAR(1000) DEFAULT NULL, paragraphs LONGTEXT DEFAULT NULL, image1_src VARCHAR(500) DEFAULT NULL, image2_src VARCHAR(500) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE meet_hanna (id INT AUTO_INCREMENT NOT NULL, meet_hanna_section_title VARCHAR(500) DEFAULT NULL, meet_hanna_section_subtitle VARCHAR(500) DEFAULT NULL, meet_hanna_image1 VARCHAR(500) DEFAULT NULL, meet_hanna_image2 VARCHAR(500) DEFAULT NULL, meet_hanna_paragraph1 LONGTEXT DEFAULT NULL, meet_hanna_paragraph2 LONGTEXT DEFAULT NULL, meet_hanna_cta_title VARCHAR(255) DEFAULT NULL, meet_hanna_cta_link VARCHAR(500) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE intro_section');
        $this->addSql('DROP TABLE meet_hanna');
        $this->addSql('ALTER TABLE about CHANGE name name VARCHAR(255) DEFAULT \'NULL\', CHANGE shor_description shor_description VARCHAR(255) DEFAULT \'NULL\', CHANGE long_description long_description VARCHAR(2000) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE article CHANGE picture picture VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE category_link CHANGE link_to link_to VARCHAR(255) DEFAULT \'NULL\', CHANGE category_title category_title VARCHAR(255) DEFAULT \'NULL\', CHANGE image image VARCHAR(500) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE category_section CHANGE main_categories_section_heading main_categories_section_heading VARCHAR(500) DEFAULT \'NULL\', CHANGE main_categories_section_subheading main_categories_section_subheading VARCHAR(500) DEFAULT \'NULL\'');
