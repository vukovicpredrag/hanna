 ...
 */
final class Version20240913113624 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE footer (id INT AUTO_INCREMENT NOT NULL, footer_heading VARCHAR(500) DEFAULT NULL, footer_paragraph LONGTEXT DEFAULT NULL, cta1_link VARCHAR(255) DEFAULT NULL, footer_box1_icon VARCHAR(255) DEFAULT NULL, footer_box1_text1 VARCHAR(500) DEFAULT NULL, footer_box1_text2 VARCHAR(500) DEFAULT NULL, footer_box2_icon VARCHAR(500) DEFAULT NULL, footer_box2_text1 VARCHAR(500) DEFAULT NULL, footer_box2_text2 VARCHAR(500) DEFAULT NULL, footer_box3_icon VARCHAR(500) DEFAULT NULL, footer_box3_text1 VARCHAR(500) DEFAULT NULL, footer_box3_text2 VARCHAR(500) DEFAULT NULL, footer_box4_icon VARCHAR(500) DEFAULT NULL, footer_box4_text1 VARCHAR(500) DEFAULT NULL, footer_box4_text2 VARCHAR(500) DEFAULT NULL, facebook_link VARCHAR(255) DEFAULT NULL, instagram_link VARCHAR(255) DEFAULT NULL, linkedin_link VARCHAR(255) DEFAULT NULL, youtube_link VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE contact ADD main_title_pre_text LONGTEXT DEFAULT NULL, ADD main_title VARCHAR(255) DEFAULT NULL, ADD paragraph LONGTEXT NOT NULL, ADD location VARCHAR(255) DEFAULT NULL, ADD map_link VARCHAR(500) DEFAULT NULL, ADD map_html_embed LONGTEXT DEFAULT NULL, ADD map_section_pre_text VARCHAR(255) NOT NULL, ADD map_section_title VARCHAR(255) DEFAULT NULL, DROP info_text, DROP address, CHANGE phone phone VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE category_link CHANGE link_to link_to VARCHAR(255) DEFAULT \'NULL\', CHANGE category_title category_title VARCHAR(255) DEFAULT \'NULL\', CHANGE image image VARCHAR(500) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE category_section CHANGE main_categories_section_heading main_categories_section_heading VARCHAR(500) DEFAULT \'NULL\', CHANGE main_categories_section_subheading main_categories_section_subheading VARCHAR(500) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE contact ADD info_text VARCHAR(2000) DEFAULT \'NULL\', ADD address VARCHAR(255) DEFAULT \'NULL\', DROP main_title_pre_text, DROP main_title, DROP paragraph, DROP location, DROP map_link, DROP map_html_embed, DROP map_section_pre_text, DROP map_section_title, CHANGE phone phone VARCHAR(255) DEFAULT \'NULL\', CHANGE email email VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE hero_section CHANGE main_title_pre_text main_title_pre_text VARCHAR(255) DEFAULT \'NULL\', CHANGE main_title main_title VARCHAR(255) DEFAULT \'NULL\', CHANGE cta1_link cta1_link VARCHAR(255) DEFAULT \'NULL\', CHANGE cta1_title cta1_title VARCHAR(255) DEFAULT \'NULL\', CHANGE cta2_link cta2_link VARCHAR(500) DEFAULT \'NULL\', CHANGE cta2_link_text cta2_link_text VARCHAR(255) DEFAULT \'NULL\', CHANGE type type VARCHAR(255) DEFAULT \'NULL\', CHANGE background_image background_image VARCHAR(1000) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE intro_section CHANGE h2_text h2_text VARCHAR(500) DEFAULT \'NULL\', CHANGE sub_h2_text sub_h2_text VARCHAR(1000) DEFAULT \'NULL\', CHANGE image1_src image1_src VARCHAR(500) DEFAULT \'NULL\', CHANGE image2_src image2_src VARCHAR(500) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE media_object CHANGE file_path file_path VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE meet_hanna CHANGE meet_hanna_section_title meet_hanna_section_title VARCHAR(500) DEFAULT \'NULL\', CHANGE meet_hanna_section_subtitle meet_hanna_section_subtitle VARCHAR(500) DEFAULT \'NULL\', CHANGE meet_hanna_image1 meet_hanna_image1 VARCHAR(500) DEFAULT \'NULL\', CHANGE meet_hanna_image2 meet_hanna_image2 VARCHAR(500) DEFAULT \'NULL\', CHANGE meet_hanna_cta_title meet_hanna_cta_title VARCHAR(255) DEFAULT \'NULL\', CHANGE meet_hanna_cta_link meet_hanna_cta_link VARCHAR(500) DEFAULT \'NULL\'');
