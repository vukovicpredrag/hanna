 ...
 */
final class Version20240913110517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sale_section (id INT AUTO_INCREMENT NOT NULL, sale_section_title VARCHAR(255) DEFAULT NULL, sale_section_paragraph VARCHAR(1000) DEFAULT NULL, sale_section_link VARCHAR(500) DEFAULT NULL, sale_section_link_title VARCHAR(500) DEFAULT NULL, image1 VARCHAR(500) DEFAULT NULL, image2 VARCHAR(500) DEFAULT NULL, image3 VARCHAR(500) DEFAULT NULL, image4 VARCHAR(500) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE tabs_section_intro (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE tabs_section_tabs_data (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) DEFAULT NULL, image VARCHAR(500) DEFAULT NULL, slide_image VARCHAR(500) DEFAULT NULL, text LONGTEXT DEFAULT NULL, link_to VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE tabs_section_text (id INT AUTO_INCREMENT NOT NULL, tab_section_title VARCHAR(255) DEFAULT NULL, tab_section_subtitle VARCHAR(500) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE sale_section');
        $this->addSql('DROP TABLE tabs_section_intro');
        $this->addSql('DROP TABLE tabs_section_tabs_data');
        $this->addSql('DROP TABLE tabs_section_text');
        $this->addSql('ALTER TABLE about CHANGE name name VARCHAR(255) DEFAULT \'NULL\', CHANGE shor_description shor_description VARCHAR(255) DEFAULT \'NULL\', CHANGE long_description long_description VARCHAR(2000) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE article CHANGE picture picture VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE category_link CHANGE link_to link_to VARCHAR(255) DEFAULT \'NULL\', CHANGE category_title category_title VARCHAR(255) DEFAULT \'NULL\', CHANGE image image VARCHAR(500) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE category_section CHANGE main_categories_section_heading main_categories_section_heading VARCHAR(500) DEFAULT \'NULL\', CHANGE main_categories_section_subheading main_categories_section_subheading VARCHAR(500) DEFAULT \'NULL\'');
