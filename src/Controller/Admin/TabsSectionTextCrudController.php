...
class TabsSectionTextCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return TabsSectionText::class;
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            // IdField::new('id'),
            TextField::new('tabSectionTitle', 'Naslov sekcije tabova'),
            TextField::new('tabSectionSubtitle', 'Podnaslov sekcije tabova'),
        ];
    }
