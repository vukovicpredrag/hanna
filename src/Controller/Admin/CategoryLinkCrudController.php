...
class CategoryLinkCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('categoryTitle', 'Naslov kategorije'),
            TextareaField::new('categoryShortDescription', 'Kratak opis kategorije'),
            TextareaField::new('categoryCtaText', 'CTA tekst kategorije'),
