...
class CategorySectionCrudController extends AbstractCrudController
{
    ...
    {
        return [
            TextField::new('mainCategoriesSectionHeading', 'Naslov glavne sekcije kategorija'),
            TextField::new('mainCategoriesSectionSubheading', 'Podnaslov glavne sekcije kategorija'),
        ];
    }
}
